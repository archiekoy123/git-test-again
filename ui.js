class UI {
    constructor(){
        this.profile = document.getElementById('profile'); //this. = to class UI
    }
    ...
    showProfile(user) {
        ...
        <div class="col-md-9"><span class="badge badge-primary">Public Repos: ${user.public_repos}</span>
                             <span class="badge badge-secondary">Public Gists: ${user.public_repos_gists}</span>
                             <span class="badge badge-success">Followers: ${user.public_repos_followers}</span>
